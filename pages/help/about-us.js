					...
					<div id="middle" className="innerbg view-all-lottery" style={{ marginTop: 32 }}>
						<div className="wrap">
							...
							<div className="main-content">
								...
								<p>
									The Bitcoin.comLottery is part of the Bitcoin.com Group. The Bitcoin.comLottery web portal provides our&nbsp;BCH and BTC wallet holders with a interactive lottery experience that combines high technological advances with a simple interface that fosters a satisfying user experience.</p>
								...
								<p>
									The Bitcoin.comLottery services included in this website acts as a portal for all major lotteries, where you may choose your lotto, pick your favourite numbers and buy your tickets using BCH and BTC as a preferred currency.</p>
								...
								<p>
									Send us an e-mail to: <a href="mailto:support-lottery@bitcoin.com">support-lottery@bitcoin.com</a></p>
